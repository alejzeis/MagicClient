...
/**
 * Constants for MCPE. All credit to BlockServerProject(http://blockserver.org).
 */
public interface MCPEConstants {

    /**
     * Client ID sent to servers. It is different every RunTime.
     */
    public final static long clientID = new Random().nextLong();
